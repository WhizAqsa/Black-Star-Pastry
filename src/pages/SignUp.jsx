...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const SignUpDetails = { firstname, lastname, email, password, birthday };
    try {
      await Axios.post(
        "http://localhost:4000/api/blackstarpastry/SignUp",
        SignUpDetails
        ...
        <div className="w-full relative bg-black rounded-lg shadow-md dark:border md:mt-0 md:max-w-md xl:p-0">
          ...
          <div className="p-6 space-y-4 md:space-y-6 md:p-8">
            ...
            <p className="text-md tracking-tighter text-center text-white">
              SignUp to our website to connect with friends, share moments, and
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-center">
                <button
                  type="submit"
                  className="w-32 h-10 text-black bg-white  font-medium rounded-lg text-md px-5 py-2 text-center"
                >
                  SIGN UP
                </button>
              </div>
